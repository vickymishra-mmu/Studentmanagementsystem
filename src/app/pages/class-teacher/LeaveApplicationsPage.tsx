...
export default function ClassTeacherLeaveApplicationsPage() {
  ...
  const loadApplications = () => {
    ...
    const classApplications = allApplications.filter(
      (app: any) => app.sentTo === 'class_teacher' && app.studentClass === user?.assignedClass
    );
    setApplications(classApplications);
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {pendingCount > 0 && (
                    <p className="text-sm text-orange-600">{pendingCount} pending applications</p>
                  )}
                </div>
              </div>
            </div>
